...
import { buildTeacherLessonClosurePath } from "@/routes/frontend";

export default function TeacherLessonClosureScreen() {
  ...
  return <FrontendShellScreen path={buildTeacherLessonClosurePath(normalizedBookingId ?? "")} />;
}
