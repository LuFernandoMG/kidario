          ...
          <>
            <section className="grid grid-cols-2 gap-3">
              <div className="card-kidario p-4">
                <p className="text-xs text-muted-foreground">Próximas aulas</p>
            ...
            <section className="grid grid-cols-2 gap-3">
              ...
              <Link to={TEACHER_PLANNING_PATH} className="card-kidario p-4 block">
                ...
                <p className="text-sm text-foreground mt-1">
                  {data.planning.available_slots_count} horários livres (14 dias)
                </p>
              </Link>
            ...
            <Dialog open={Boolean(selectedLessonId)} onOpenChange={(open) => !open && setSelectedLessonId(null)}>
              <DialogContent className="max-w-2xl p-0">
                <div className="p-4 space-y-3 max-h-[85vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle>Detalhe da agenda</DialogTitle>
                    <DialogDescription>Revisar a informação completa e definir uma ação.</DialogDescription>
                  </DialogHeader>
                  {selectedLesson ? (
                    <>
                      <LessonDetailCard
