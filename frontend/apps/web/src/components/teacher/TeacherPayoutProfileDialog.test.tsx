...
describe("TeacherPayoutProfileDialog", () => {
  ...
  it("requires account password when editing an existing payout profile", () => {
    render(
      <TeacherPayoutProfileDialog
        open
        initialProfile={{
    ...
    expect(screen.getByPlaceholderText("Confirme sua senha para salvar alterações")).toHaveAttribute("type", "password");
